...
public class OrganicFeline extends VirtualPet implements Organic {

	private int hungerLevel;
	private int thirstLevel;

	public OrganicFeline(String name, String description, int healthLevel, int happinessLevel, int hungerLevel,
			int thirstLevel) {

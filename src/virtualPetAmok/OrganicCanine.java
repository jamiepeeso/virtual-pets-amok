...
public class OrganicCanine extends CaninePet implements Organic {

	private int hungerLevel;
	private int thirstLevel;
	private int wasteLevel;

	public OrganicCanine(String name, String description, int healthLevel, int happinessLevel, int hungerLevel,

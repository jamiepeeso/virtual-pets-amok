...
public class RobotCanine extends CaninePet implements Robot {

	private int maintenanceLevel;

	public RobotCanine(String name, String description, int healthLevel, int happinessLevel, int maintenanceLevel) {
